...
namespace CarDesign.Model
{
  ...
  public partial class CylinderHead : ReferenceableObject
  {
    static CylinderHead() {}

    private static readonly SchemaClass _schemaClass = new SchemaClass("CarDesign.Model.CylinderHead", 1000002, 1001);
    ...
    protected CylinderHead(ObjectId id) : base(id) {}
    ...
    new public static CylinderHead CreateProxyForId(ObjectId id)
    {
      return new CylinderHead(id);
    }
