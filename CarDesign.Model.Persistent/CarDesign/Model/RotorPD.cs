...
namespace CarDesign.Model
{
  ...
  public partial class Rotor : ReferenceableObject
  {
    static Rotor() {}

    private static readonly SchemaClass _schemaClass = new SchemaClass("CarDesign.Model.Rotor", 1000000, 1001);
    ...
    protected Rotor(ObjectId id) : base(id) {}
    ...
    new public static Rotor CreateProxyForId(ObjectId id)
    {
      return new Rotor(id);
    }
